...
<display:table pagesize="5" class="displaytag" keepStatus="true" name="applications" requestURI="${requestURI}" id="row">
    ...
    <spring:message code="changeStatus" var="changeHeader"/>
    <display:column title="${changeHeader }">
        <a href="application/${row.id}/change.do?action=ACCEPT">
            <spring:message	code="accept" />
        </a>  <a href="application/${row.id}/change.do?action=DENIED">
